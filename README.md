...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-07-19 17:38`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/63a063d4-c11f-4adb-b841-9e9bcce1555a.git
$ cd 63a063d4-c11f-4adb-b841-9e9bcce1555a
```
